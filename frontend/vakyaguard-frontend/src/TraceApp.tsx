...
import { Layout } from './components/trace/Layout.tsx';
import { Uploader } from './components/trace/Uploader.tsx';
import { AudioRecorder } from './components/trace/AudioRecorder.tsx';
import { ResultView } from './components/trace/ResultView.tsx';
import { ProcessingView } from './components/trace/ProcessingView.tsx';
import { EducationalPanel } from './components/trace/EducationalPanel.tsx';
import { CodeViewer } from './components/trace/CodeViewer.tsx';
...
const TraceApp: React.FC = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // Transform backend response to TRACE format
      const traceReport: AnalysisReport = {
        decision: backendResponse.decision === 'SPOOF' ? DetectionResult.SPOOF : DetectionResult.BONAFIDE,
        ...
        technicalDetails: {
          spectralAnomalies: backendResponse.technicalDetails.spectralAnomalies,
          temporalInconsistencies: backendResponse.technicalDetails.temporalInconsistencies,
          syntheticArtifacts: backendResponse.technicalDetails.syntheticArtifacts
        }
      };
